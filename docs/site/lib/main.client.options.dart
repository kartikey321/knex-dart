...
import 'package:site/components/github_button.dart' deferred as _github_button;
...
ClientOptions get defaultClientOptions => ClientOptions(
  clients: {
    ...
    'github_button': ClientLoader(
      (p) => _github_button.MyGitHubButton(repo: p['repo'] as String),
